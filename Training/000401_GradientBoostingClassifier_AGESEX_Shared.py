...
modelstring = str(ROWS) + "_BALANCED_SNIPPET_ONLYAGESEX_" + ("{:.3f}".format(auc))

filename="/RAWDATA/TRAINEDMODELS/BCC_CENS_LISA06_MIG/GradBoost/AGESEXONLY/" + str(clf) + hpstring + modelstring + ".sav"
