...
MASTER = MASTER[["MM_BETWEEN_INDEX_AND_ENDDATE", "GROUP_TRAINVALTEST_BALANCED", "Kon_equals_1", "AGE_INDEX_5_(-inf, 35.0]", "AGE_INDEX_5_(35.0, 40.0]", "AGE_INDEX_5_(40.0, 45.0]", "AGE_INDEX_5_(45.0, 50.0]", "AGE_INDEX_5_(50.0, 55.0]", "AGE_INDEX_5_(55.0, 60.0]", "AGE_INDEX_5_(60.0, 65.0]", "AGE_INDEX_5_(65.0, 70.0]", "AGE_INDEX_5_(70.0, 75.0]", "AGE_INDEX_5_(75.0, 80.0]", "AGE_INDEX_5_(80.0, 85.0]", "AGE_INDEX_5_(85.0, inf]"]].copy()
...
modelstring = str(ROWS) + "_AGESEX_BALANCED_ALLCols_" + ("{:.4f}".format(auc))

filename="/RAWDATA/TRAINEDMODELS/BCC_CENS_LISA06_MIG/MLP/AGESEX/" + str(clf) + hpstring + modelstring + ".sav"
